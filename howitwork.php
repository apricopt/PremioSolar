		...
		<div class="container-fluid">
		  ...
		  <div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav m-auto">
				...
				<li class="nav-item active"><a href="howitwork.php" class="nav-link">HOW IT WORK</a></li>
...
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/image_3.jpg');" data-stellar-background-ratio="0.6">
  <div class="overlay"></div>
  <div class="container">
	<div class="row no-gutters slider-text align-items-end justify-content-center">
	  <div class="col-md-9 ftco-animate pb-5 text-center">
		<h1 class="mb-3 bread">How It Work</h1>
		<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>How It Work <i class="ion-ios-arrow-forward"></i></span></p>
	  </div>
	</div>
  </div>
</section>
  ...
  <!----  <div class="container pt-5 pb-4">
	    ...
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	<li class="nav-item active"><a href="index.php" class="nav-link">HOW IT WORK</a></li>
	        	<li class="nav-item"><a href="about.php" class="nav-link">COMMUNITY</a></li>
            <li class="nav-item"><a href="services.php" class="nav-link">COMMERCIAL</a></li>
	        	<li class="nav-item"><a href="gallery.php" class="nav-link">REVIEWS</a></li>
	        	<li class="nav-item"><a href="blog.php" class="nav-link">SUPPORT</a></li>
			  <li class="nav-item"><a href="about.php" class="nav-link">ABOUT</a></li>
			  <li class="nav-item"><a href="about.php" class="nav-link">NEWS</a></li>
...
<!-- hero section here --
	...
	<!-----------------------------------nav + hero section is close here----------------------------------->
	          ...
	          <div class="heading-section ftco-animate">
    			...
    			<div class="col-lg-11 services-wrap px-4 pt-5">
    				<div class="row pt-md-3">
    					<div class="col-md-4 d-flex align-items-stretch mt-5">
		    				<div class="services text-center">
		    					<div class="icon d-flex justify-content-center align-items-center">
									<span class="fab fa-contao "></span></a>
		    					</div>
		    					<div class="text">
		    						<h3>Consultation</h3>
		    						<p>
										 Premio Solar’s expert Solar Specialist will provide a complimentary consultation to see if your home is a fit for one of our $0 upfront Solar & Battery programs.</p>
		    					</div>
		    			...
		    			<div class="col-md-4 d-flex align-items-stretch  mt-5">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						...
		    						<p>As your system is installed and generating solar power, you may become a Solar Ambassador spreading the solar message earning money!</p>
		    					</div>
						...
						<div class="col-md-4 d-flex align-items-stretch  mt-5">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						...
		    						<p>The 3 keys to identifying if you and your home are a match for our Solar Simplified program- Roof, Electric Bill, and Personal Credit.</p>
						...
						<div class="col-md-4 d-flex align-items-stretch  mt-5">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						<h3>Savings Plan</h3>
		    						<p>
										Based on your annual energy usage, a customized Solar Savings Plan will be created showcasing your savings, the design, home appreciation, environmental benefits & more!</p>
		    					</div>
		    					<a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
		    				</div>
						</div>
						...
						<div class="col-md-4 d-flex align-items-stretch  mt-5">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						<h3> Free Products & Incentives</h3>
		    						<p>
										When you move forward, you will gain access to our Sunny Savings Program with free products and incentives.</p>
		    					</div>
		    					<a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
		    				</div>
		    			</div>
		    			<div class="col-md-4 d-flex align-items-stretch  mt-5 ">
		    				<div class="services text-center">
		    					...
		    					<div class="text">
		    						<h3> White Glove Walkthrough</h3>
		    						<p>Once you join the  Premio Solar Family, our 5 star, white glove concierge team will walk you thru our Stairway to Solar process from sale to installation.</p>
		    					</div>
		    					<a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
		    				</div>
		    			</div>
...
<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
	<div class="container">
		<div class="row d-flex">
			...
			<div class="col-md-6 pl-md-5 " style="margin-bottom: 20px;">
				...
				<h1 class="mb-4">
					...
					<p class="">
						Premio solar helps you to get freedom and control over electricity. Your home is powered by rooftop solar panels during the day and by energy stored in the battery at night with a residential solar system. By investing in solar panels, you gain energy independence. Now increasing affordability of solar panels is the availability of federal, state and local tax breaks.
...
.</p>
				...
				<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end" style="background-image:url(images/practice-1.jpg);box-shadow: 0px 0px 10px yellow;">
	...
	<div class="container">
	  <div class="row justify-content-center mb-5 pb-3">
		<div class="col-md-7 heading-section text-center ftco-animate">
			<span class="subheading">Save Green By</span>
		  <h2>GOING GREEN</h2>
		</div>
	  </div>
	  <div class="row d-flex">
		<div class="col-md-4 d-flex ftco-animate">
			...
			<a href="blog-single.php" class="block-20" >
			  <img src="images/logo1.png" class="d-block mx-auto" style="height: 150px; ">
			</a>
			<div class="text p-4 float-right d-block">
				
				<h3 class="heading mb-0"><a href="#">Save Watts of Money</a></h3>
			  <p> Premio Solar believes in the core Solar benefits. Locked in energy costs. Mobile monitoring. Increased home value. Lucrative referral bonuses.</p>
		...
		<div class="col-md-4 d-flex ftco-animate">
			...
			<div class="text p-4 float-right d-block">
			  ...
			  <p>
				  Get a $0 Down Solar Financing Solution created just for you home. Combine this with State Incentives in Florida, Georgia, North Carolina,</p>
			  <p><a href="#" class="btn btn-primary">Read more</a></p>
			</div>
		  </div>
		</div>
...
Take advantage of The Federal Investment Tax Credit (ITC).  Get back 26% of your system’s cost when you have a tax liability.</p>
			<p><a href="#" class="btn btn-primary">Read more</a></p>
		  </div>
		</div>
	  </div>
	  <div class="col-md-4 d-flex ftco-animate ">
		  <div class="blog-entry justify-content-end">
			  <div class="z_padding">
		  <a href="blog-single.php" class="block-20  py-1" >
		   <img src="images/logo5.png" class="d-block mx-auto" style="height: 150px; ">
		  </a>
	  </div>
		  <div class="text p-4 float-right d-block">
		  
			  <h3 class="heading mb-0"><a href="#">Become an Ambassador</a></h3>
			<p>
				
				 Download the GoSolar App. Start earning referral $$$. Educate your community on the benefits of going solar.</p>
			<p><a href="#" class="btn btn-primary">Read more</a></p>
		  </div>
		</div>
	  </div>
	  <div class="col-md-4 d-flex ftco-animate">
		  <div class="blog-entry justify-content-end">
		  <a href="blog-single.php" class="block-20 ">
			  <img src="images/logo6.png"  class="d-block mx-auto" style="height: 150px; ">
		  </a>
		  <div class="text p-4 float-right d-block">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">“After installing solar panels my electric bill is awesome!”</p><br><br><br><br><br><br>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_1.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Terrance W. St. Johns, FL System Size: 6.5KW</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">“I am one step away from going live with Solar. This Company has impressed me every step of the way. Absolutely everyone I have been in contact with is not only knowledgeable but personable. Every step has been clearly explained.“</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_2.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Della L. P., from Spring Hill, FL | System Size: 9.9 KW</p>
		                    <span class="position">Home Owner</span>
		                  </div>
	                  </div>
                  </div>
                </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">“ I couldn’t be happier that I went with  Premio Solar Program! I am saving so much money! I got quotes from several other companies and nothing compared! Everyone who helped along the way were extremely professional, knowledgeable, and understanding”</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_3.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Pamela C., from Chipley | System Size: 5.13 KW</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">“The Go Solar team is the best in Florida. Right off the top they discussed how to reduce my consumption before we even installed a single panel. The technicians are top notch, and did everything right the first time.”</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_1.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Scot and Debbie C., from Gulf Breeze, FL | System Size: 7.02 KW</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
	                  </div>
                  </div>
