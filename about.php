...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/z3.jpg');background-attachment: fixed;" >
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 ftco-animate">
                <!-- <p>
                  <img src="images/eco.jpg" alt="" class="img-fluid bulb">
                </p> -->
                <h2 class="mb-3">
                  About Premio solar:
                  </h2>
                <p>Premio solar  is  providing solar consultation for you to chose best solar options and see the drastic reduction in your  monthly electricity bills with fixed rates for as long as 25 years. You can get independent solar electric power that can mostly balance or completely eliminate your electric bill. Our vision is to provide eco-friendly environment to every home and the access to clean energy by eliminating all barriers. Premio solar plays a key role in educating home owners about solar energy’s benefits & make it feasible for them to switch to solar.</p>
                <p>As we know that the rates of electricity are increased every year. So this is the right time to switch to Solar and say no to increased bills and make a wise and economical decision for your home. 
                </p>
                <h2 class="mb-3">Switch to Solar easily</h2>
                <p>
                  An energy efficient home requires fewer solar panels thus saving you thousands of dollars on your solar install. Now it has become easier for you to switch to solar since our partners provide best finance options. The costs of solar systems have decreased at an incredible rate in the past few years. There are a few options where the customer can enjoy the benefits of solar without having to pay for it at once. PPA, this is a method in which the customer only pays for the power he purchases. Therefore, solar is the answer to all your worries. 
                  </p>
              ...
              <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                  ...
                  <img src="images/eco.jpg" alt="" class="img-fluid bulb">
                    <!-- <h3 class="mt-3">Updates</h3>
                   <div class="block-21 mb-4 d-flex"> 
                    <a class="blog-img mr-4" style="background-image: url(images/icon2.png);"></a>
                    <div class="text">
                      <h3 class="heading"><a href="#">New Solar offers in Utah.</a></h3>
                      
                    </div>
                  </div>
                  <div class="block-21 mb-4 d-flex">
                    <a class="blog-img mr-4" style="background-image: url(images/icon3.png);"></a>
                    <div class="text">
                  ...
                  <div class="block-21 mb-4 d-flex">
                    <a class="blog-img mr-4" style="background-image: url(images/icon4.png);"></a>
                    <div class="text">
