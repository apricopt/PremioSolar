...
<html lang="en">
  ...
  <body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
			<div class="container-fluid">
			  ...
			  <div class="collapse navbar-collapse" id="ftco-nav">
				...
				<li class="nav-item active"><a href="comercial.php" class="nav-link">COMMERCIAL</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/z2.jpg');background-position: bottom;background-attachment: fixed;" >
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Commercial</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Commercial <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb bg-light my-5">
			<div class="container">
				<div class="row d-flex">
					...
					<div class="col-md-6 pl-md-5">
						...
						<h1 class="mb-4">
									Commercial Solar with Premio</h1>
		
						
									<p>
										We have been entrusted to design, build and monitor large-scale solar systems. Portfolio of commercial clients, ranging from small businesses to the largest corporate and municipal entities gives you peace of mind that you and your company’s future are in good hands.
									</p>

							
						</div>
					  </div>	<div class="col-md-6 d-flex">
						<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end" style="background-image:url(images/solarbg2.jpg);box-shadow: 0px 0px 10px yellow;">
	...
	<div class="row" id="row4" style="padding-top:0px;	background-image:
	linear-gradient(to bottom, rgba(48, 255, 21, 0.555), rgba(0, 0, 0, 0.507)),
	url('images/commercialheadd.jpg');background-attachment: fixed;">
		...
		<div class="col-12 col-sm-12 col-md-6 col-lg-6 " id="row4_a">
		  <div class="green_heading" style="background-color:transparent; height: 300px;">
			<h3  >
				Increase  </h3>
			<h3  >Your Asset's Value</h3>
		  </div>
		  <div id="form_sider" class="cta bg_blue">
			<h1 class="zheading mt-5">Take your Step today</h1>
			<p class="zpara pr-3 pl-3 ">Powerwall integrates with solar to store excess energy generated during the day and makes it available when you need it, minimizing reliance on your utility.</p>
		  </div>
		  ...
		  <div class="col-12 col-sm-12 col-md-5 col-lg-5 bg_blue" id="row4_b" >
			<div class="pt-3" >
			<h3>Your Data is precious for us!</h3>
			</div>
			<div class="p-4">
			  <form action="form_clients.php" method="POST" data-aos="fade-up" enctype="multipart/form-data">
				...
				<div class="form-group">
				 ...
				 <select class="custom-select" id="inputGroupSelect01" name="z_state">
				   <option>Choose...</option>
					<option value="Utah" required>Utah</option>
    ...
    <!-- <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-10 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">Operating Lease</h2>
          </div>
        </div>
        <div class="row">
        	<div class="col-md-12">
              ...
              <div class="item">
              	<div class="wrap">
			        		...
			        		<div class="text text-center px-4">
		        				<h3><a href="#">Reduced Payment</a></h3>
		        				<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
		        			</div>
		        		</div>
              </div>
