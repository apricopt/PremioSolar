...
if($conn) {
    ...
    $time= $_POST["z_callback"];
     ...
     $sql ="INSERT INTO customer(customer_name, z_email,  address, state_name, contact, property_type, shade, credit_score, electric_bill, callback)
    VALUES('$name', '$email' ,  '$address' , '$state', '$contact' ,'$property', '$shade', '$creditScore', '$bill', '$time')";
